...
face_cascade = cv2.CascadeClassifier('C:/Users/shyaa/Desktop/Lock_Unlock_Using_Face_Recognition/haarcascade_frontalface_default.xml') # Detect object in video stream using Haarcascade Frontal Face
